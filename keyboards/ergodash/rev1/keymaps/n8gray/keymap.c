...
#define SYMBOL_LAYER5		_______, _______, _______, _______, _______, _______, KC_PMNS, 				_______, _______, KC_UNDS, _______, KC_HOME, KC_PGDOWN, KC_END
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_4key(
	  ...
	  KC_CAPS, KC_MUTE,   TT(_NAV), KC_LALT,       KC_LGUI,   LOWER, KC_SPC, KC_ENT,  RAISE,  KC_SPC,         KC_SLASH, KC_LEFT, KC_DOWN, KC_RGHT
	  ),
	[_LOWER] = EXPAND_LAYER(
		SYMBOL_LAYER1,
		SYMBOL_LAYER2,
	...
	[_NAV] = LAYOUT_4key(
		...
		_______, _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______, 				_______, KC_PGUP, KC_HOME,   KC_UP,  KC_END, _______, _______, 
		_______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______, 				_______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, 
		_______, _______, _______, _______, _______, _______, _______, 				_______, _______, _______, _______, _______, _______, _______, 
		_______, _______, _______, _______, _______, _______, _______, 			    _______, _______, _______, _______, _______, _______, _______
		),
	[_ADJUST] = LAYOUT_4key(
